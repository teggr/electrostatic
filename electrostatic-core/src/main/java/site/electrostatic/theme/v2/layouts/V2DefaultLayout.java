package site.electrostatic.theme.v2.layouts;
...
import site.electrostatic.theme.v2.includes.V2Footer;
import site.electrostatic.theme.v2.includes.V2Head;
import site.electrostatic.theme.v2.includes.V2Header;
