...
public class BuildMojo extends AbstractMojo {
	...
	@Parameter(property = "electro.baseDir", defaultValue = "${project.basedir}/src/main/resources")
	private File baseDir;

	@Parameter(property = "electro.outputDir", defaultValue = "${project.build.directory}/electro")
